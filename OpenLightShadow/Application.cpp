...
void Application::render()
{
    ...
    glm::mat4 worldMatrix = glm::rotate(glm::mat4(1.0f), 20.0f*(glm::pi<float>()/180.0f), glm::vec3(1.0f, 0.0, 0.0));
    worldMatrix *= glm::rotate(glm::mat4(1.0f), m_elapsedTime, up);
    worldMatrix *= glm::scale(glm::mat4(1.0f),glm::vec3(2,2,2));
    // Camera et projection
    glm::vec3 camera_position{ 0.f, 0.f, 50.f };
